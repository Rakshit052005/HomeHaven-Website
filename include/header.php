...
<body>
   ...
   <header>
      ...
      <?php  
       ...
       {
        $cust_id =  $_SESSION['id'];
        $query = "SELECT * FROM cart WHERE cust_id=5";
       ...
       <!--header ---> 
             <nav class="navbar navbar-expand-md navbar-light bg-light fixed-top">
               <a href="" class="navbar-brand"> 
                   <img src="img/favicon.png" width="40px" height="40px"> The <sapn class="font-weight-bold">Handy Home</sapn>
               </a>
